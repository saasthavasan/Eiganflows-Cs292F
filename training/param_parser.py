...
def parameter_parser():
    ...
    parser.add_argument("--input-path",
                        nargs="?",
                        default="/Users/d3xt3r/personal/Courses/Spring22/final_project/Eiganflows-Cs292F/data/dataset/",
	                help="Input folder with jsons.")

    parser.add_argument("--output-path",
                        nargs="?",
                        default="/Users/d3xt3r/personal/Courses/Spring22/final_project/Eiganflows-Cs292F/training/output/nci1.csv",
